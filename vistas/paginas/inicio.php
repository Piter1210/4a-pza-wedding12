         ...
         <div class="row g-4 justify-content-center">
            <div class="col-lg-12">
               <div class="banner__content center">
                  ...
                  <h5 class="wow fadeInUp" data-wow-duration="2s">The beautiful wedding of</h5>
                   <h1 class="wow fadeInDown" data-wow-duration="4s">Ariel & Willian</h1>
                   <h3 class="wow fadeInUp" data-wow-duration="2s">We look forward to your attendance</h3>
               </div>
            </div>
         </div>
      </div>
